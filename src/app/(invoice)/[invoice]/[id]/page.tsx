...
const InvoiceId = () => {
  ...
  if (isPending || !invoice || markIsPending) {
    return (
      <div className="mx-auto md:w-[45rem] sm:w-[35rem] w-[20rem] min-h-[80vh] mt-28">
  ...
  return (
    <>
      <div className="fixed z-40 bottom-0 w-full sm:hidden py-6  dark:bg-foreground bg-slate-100">
      ...
      <div className="mx-auto md:w-[45rem] relative sm:w-[35rem] w-[20rem] min-h-[80vh] mt-28">
        <div
        ...
        <div className="h-[20%]  dark:bg-foreground p-8 rounded-lg invoice-shadow">
          <div className="flex items-center w-full justify-between">
            <div className="flex items-center sm:justify-center justify-between sm:w-fit w-full gap-x-4">
          ...
          <div>
            ...
            <div className="flex md:flex-row flex-col items-start w-full md:justify-between justify-center gap-y-4">
              ...
              <div>
                ...
                <h2>
                  <span className="sm:font-bold font-semibold sm:text-xl text-lg">
                    {invoice?.clientEmail}
                  </span>
                </h2>
              </div>
